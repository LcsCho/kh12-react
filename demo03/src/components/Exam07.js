...
const Exam07 = () => {
    ...
    const checkMember =  () => {
        ...
        //PW-RE검사
        const pwReMatch = member.memberPw.length === 0 ? null :
                ...
                <div className="col-md-10 offset-md-1">
                    ...
                    <form autoComplete="off">
                        ...
                        <div className="row mt-4">
                            <div className="col">
                                ...
                                <input type="text" name="memberId" className={`
                            form-control 
                        ...
                        <div className="row mt-4">
                            <div className="col">
                                ...
                                <div className="invalid-feedback">올바른 형식의 비밀번호입니다.</div>
                            </div>
                        </div>
                    ...
                    <div className="row mt-4">
                        <div className="col">
                            ...
                            disabled={!(result.memberId === true && result.memberPw === true && result.memberPwRe === true)}>회원가입</button>
                        </div>
                    </div>
